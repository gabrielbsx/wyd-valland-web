...
class PicpayPincode extends Model
{
    protected $table = 'picpay_pincode';
    ...
    protected $validationRules = [
        'referenceId' => 'required|is_natural|is_unique[picpay_pincode.referenceId]',
        'pincode' => 'required|is_natural|is_unique[picpay_pincode.pincode]',
